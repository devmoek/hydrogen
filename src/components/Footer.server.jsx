    ...
    <footer role="contentinfo">
      <div className="relative bg-white border-t border-b border-black border-opacity-5">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            <h2 className="text-md font-medium uppercase mb-4">Pages</h2>
            <ul className="mt-8 space-y-4">
          ...
          <div>
            <h2 className="text-md font-medium uppercase mb-4">More Templates</h2>
            <ul className="mt-8 space-y-4">
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
      ...
      <div className="py-6 px-4 md:px-8 bg-gray-50">
        <p className="text-gray-600">© {new Date().getFullYear()} moek</p>
      </div>
    </footer>
  );
}
