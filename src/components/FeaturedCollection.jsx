...
export default function FeaturedCollection({collection}) {
  return collection ? (
    <div className="shadow-xl pt-8 pb-8 rounded-xl grid grid-cols-1 lg:grid-cols-2 items-center bg-white overflow-hidden">
      {collection.image ? (
      ...
      <div className="px-10 py-10 lg:py-0">
        ...
        <Link
          ...
          className="inline-block bg-gray-900 text-white text-lg font-medium rounded-md py-4 px-16 uppercase hover:bg-white hover:text-black hover:outline"
        >
          Shop Collection
        </Link>
      </div>
